...
| LCU 集成 | C# HttpClient + lockfile | `ysnskin_learn/lcu.py` + `endpoints.py` | ✅ 本轮 |
| 皮肤目录 | data/skins.json（游戏目录数据） | `ysnskin_learn/catalog.py` + `data/` | ✅ 本轮 |
...
```bash
# 0. 环境：Python 3.11+，无第三方依赖（可选：pip install zstandard xxhash 用于扩展功能）
